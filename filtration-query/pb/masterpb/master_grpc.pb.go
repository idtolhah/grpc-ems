...
type MasterServiceClient interface {
	...
	GetDirt(ctx context.Context, in *GetDirtRequest, opts ...grpc.CallOption) (*GetDirtResponse, error)
}
...
func (c *masterServiceClient) GetFilter(ctx context.Context, in *GetFilterRequest, opts ...grpc.CallOption) (*GetFilterResponse, error) {
	out := new(GetFilterResponse)
	err := c.cc.Invoke(ctx, "/master.MasterService/GetFilter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *masterServiceClient) GetDirt(ctx context.Context, in *GetDirtRequest, opts ...grpc.CallOption) (*GetDirtResponse, error) {
	out := new(GetDirtResponse)
	err := c.cc.Invoke(ctx, "/master.MasterService/GetDirt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MasterServiceServer interface {
	...
	GetDirt(context.Context, *GetDirtRequest) (*GetDirtResponse, error)
...
func (UnimplementedMasterServiceServer) GetFilter(context.Context, *GetFilterRequest) (*GetFilterResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFilter not implemented")
}
func (UnimplementedMasterServiceServer) GetDirt(context.Context, *GetDirtRequest) (*GetDirtResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDirt not implemented")
}
...
func _MasterService_GetFilter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFilterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterServiceServer).GetFilter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/master.MasterService/GetFilter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServiceServer).GetFilter(ctx, req.(*GetFilterRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MasterService_GetDirt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDirtRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterServiceServer).GetDirt(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/master.MasterService/GetDirt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServiceServer).GetDirt(ctx, req.(*GetDirtRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MasterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MasterService_GetFilter_Handler,
		},
		{
			MethodName: "GetDirt",
			Handler:    _MasterService_GetDirt_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pb/masterpb/master.proto",
}
